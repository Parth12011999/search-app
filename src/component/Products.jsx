                        ...
                        return (
                            <div className='bg-white p-6 rounded' key={product.id}>
                                <div className='aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md lg:aspect-none lg:h-80'>
                                    <img src={product.image} alt="" className='h-full w-full object-cover object-center lg:h-full lg:w-full' />
                                </div>
                                ...
                                <div className='text-black-600 text-sm font-medium flex justify-between'>
                                    <div><span className='text-lg font-bold'>Price: </span>{product.price}</div>
                                    <div><span className='text-lg font-bold'>Ratings: </span>{product.rating.rate}/5</div>
                                </div>
                            </div>
                        )
                    })
